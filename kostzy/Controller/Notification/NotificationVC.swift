...
class NotificationVC: UIViewController {
    ...
    var notifications = [Notif(date: parseDate("2020-08-12"), userImage: "Lala", userName: "Eleanor", time: "Now", userComment: "Liked your post"),
                 Notif(date: parseDate("2020-08-12"), userImage: "Other User 2", userName: "Nicholas", time: "10m", userComment: "Commented: Itu emang tempatnya pewe banget sih gilaa"),
                 Notif(date: parseDate("2020-08-12"), userImage: "Other User 2", userName: "Nicholas", time: "11m", userComment: "Liked your post"),
                 Notif(date: parseDate("2020-08-12"), userImage: "Other User 1", userName: "Justin", time: "20m", userComment: "Liked your post"),
                 Notif(date: parseDate("2020-08-11"), userImage: "Other User 4", userName: "Emily", time: "1d", userComment: "Liked your post"),
                 Notif(date: parseDate("2020-08-11"), userImage: "Rais", userName: "Rais", time: "1d", userComment: "Liked your post"),
                 Notif(date: parseDate("2020-08-11"), userImage: "Other User 6", userName: "Dinda", time: "1d", userComment: "Commented: Gue sih no bgt sama kostan itu.. Ibu kostnya rese trs kamarnya kotor"),
                 Notif(date: parseDate("2020-08-11"), userImage: "Rayhan", userName: "Rey", time: "1d", userComment: "Liked your post")]
